...
function uPrompt { # Prompts the user for vaious information, such as hostname of the Sphere, username and password
  ...
  LWRFEMAIL=$(dialog --nocancel --backtitle "$AUTHORNAME's $DRIVERNAME helper script" --inputbox "Enter the email for your lightwaverfhost.co.uk account " 0 0 "myemail@test.com" 3>&1 1>&2 2>&3)
